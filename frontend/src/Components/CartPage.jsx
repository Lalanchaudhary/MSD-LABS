      ...
      {(props.data == 0 ?
        ...
        <Container style={{ height: "100vh" }} className='mainka-box' >
          <div>
            ...
            <Link to={"/alltest"}> <Button variant="outline-primary text-dark" className='p-2 fw-bold' style={{ width: "300px", margin: "0px 90px" }}>Add more test <IoMdAdd /></Button></Link>
          </div>
          <div>
          <form className='form'>
                ...
                <label htmlFor="">₹</label>
                <input type="number" value={props.data[0].price} placeholder="price" />
                <br />
