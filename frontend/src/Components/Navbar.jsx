    ...
    <>
      <Navbar bg="light" sticky="top" className='Navbar'  >
        <Container className='contain'>
         ...
         <Link to="/Profile">  <button className='nav-btn'>Profile<CiUser className='icon1' /></button></Link>
        </Container>
      </Navbar>
      <Container className=' pb-4 pt-2 sec-nav12'  >
        <Container className=' d-flex justify-content-between' fluid>
        <Nav.Link href="#link" className='text-danger ' id="fs1"><FaCalendarPlus className='mx-2 mb-1' /> Book a Test</Nav.Link>
        <div className='d-flex gap-4'>
        <Nav.Link href="#link" className='text-dark ' id="fs1" ><IoBagCheck className='mx-2 mb-1'  />Booking & Reports</Nav.Link>
        </div>
        <Nav.Link href="/contact" className='text-dark 'id="fs1">Contact Us</Nav.Link>
        </Container>
      </Container>
    </>
  );
